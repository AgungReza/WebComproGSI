<nav class="relative flex justify-between items-center p-6 bg-black border-b border-yellow-500">
  ...
  <div class="hidden md:flex flex-1 justify-center">
    <ul class="flex space-x-6 lg:space-x-[50px]">
      <li><a href="/" class="font-bold hover:text-yellow-400">Home</a></li>
      <li><a href="/about" class="font-bold hover:text-yellow-400">About</a></li>
      <li><a href="/works" class="font-bold hover:text-yellow-400">Works</a></li>
    </ul>
  </div>
...
<div id="mobile-menu" class="hidden bg-black text-white p-4 absolute top-20 left-0 w-full border-t border-yellow-500 shadow-lg z-50">
  <ul class="flex flex-col space-y-4 text-center">
    <li><a href="/" class="block py-2 font-bold hover:text-yellow-400">Home</a></li>
    <li><a href="/about" class="block py-2 font-bold hover:text-yellow-400">About</a></li>
    <li><a href="/works" class="block py-2 font-bold hover:text-yellow-400">Works</a></li>
    <li><a href="/contact" class="block py-2 font-bold bg-yellow-400 text-black px-4 py-2 rounded hover:text-white hover:bg-black border-2 border-yellow-400">Contact Us</a></li>
  </ul>
</div>
